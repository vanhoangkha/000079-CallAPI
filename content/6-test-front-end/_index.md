...
![UpdateURL](/images/6-test-front-end/6-test-front-end-14.png?featherlight=false&width=90pc)
...
```
4. Back to browser tab where you opened the web app in part 2. The app already shows the book information, but still no pictures because we haven't uploaded the pictures yet.

![WebApp](/images/6-test-front-end/6-test-front-end-1.png?featherlight=false&width=90pc)

So the list API is working properly
5. Test writing API
...
- Click **Choose image**
- Select the image you want to upload, you can upload the following image:
...
We have finished building a simple web application following the serverless model. To build serverless applications faster, in the next section we will use the AWS Serverless Application Model (SAM). SAM provides syntax for expressing functions, APIs, databases, and event source mappings.
